...
- (void)viewDidLoad {
    ...
    [navigationItem setLeftBarButtonItem:[UIBarButtonItem CHitemWithIcon:@"btu_fanhui_w" highIcon:@"btu_fanhui_p" frame:CGRectMake(0, 0, 45, 30) target:self action:@selector(clickLeftButton) transfrom:0]];
...
//    searchBar.barTintColor = CHUIColorFromRGB(CHMediumSkyBlueColor, 1.0);
    UITextField *searchField1 = [searchBar valueForKey:@"_searchField"];
    searchField1.font = CHFontNormal(nil, 12);
