...
- (void)drawRect:(CGRect)rect
{
    ...
    //// Color Declarations
    UIColor* gradientColor = [UIColor colorWithRed: 0.267 green: 0.303 blue: 0.335 alpha: 0];
    UIColor* gradientColor2 = [UIColor colorWithRed: 0.04 green: 0.04 blue: 0.04 alpha: 0];
    UIColor* shadowColor2 = [UIColor colorWithRed: 0.524 green: 0.553 blue: 0.581 alpha: 0.];
    
//    UIColor* gradientColor = [UIColor colorWithRed: 255/255.0 green: 255/255.0 blue: 255/255.0 alpha: 1];
//    UIColor* gradientColor2 = [UIColor colorWithRed: 255/255.0 green: 255/255.0 blue: 255/255.0 alpha: 1];
//    UIColor* shadowColor2 = [UIColor colorWithRed: 255/255 green: 255/255 blue: 255/255.0 alpha: 0.3];
